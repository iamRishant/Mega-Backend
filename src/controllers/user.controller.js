...
const changeCurrentPassword = asyncHandler(async(req, res) => {
    ...
    // save hone se just pehle ek middleware use kar rhe hai models me wo check krega ki modified hai ya nhi if modified then 
    //it will encrypt it
...
const getCurrentUser = asyncHandler(async(req, res) => {
    ...
    .json(new ApiResponse(
        200,
        req.user,// this is we are adding in middleware when we did logout verifyJWT middleware
